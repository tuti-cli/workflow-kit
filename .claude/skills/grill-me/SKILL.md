---
name: grill-me
description: "Interview the user about a plan or design through structured interrogation: clarify → challenge → reality-check."
---
...
Before challenging anything, understand it. Ask questions that expose gaps and force clarity — not to attack, but to build a complete picture.
...
Once the surface is clear, introduce tension. Challenge decisions directly and concretely.
...
Now stress-test against real-world conditions.
...
- Right: "This introduces tight coupling between A and B, which makes future changes risky"

- Wrong: "This might cause issues"
- Right: "This will degrade past ~N records because there's no indexing or batching"

## Resolution rule

Resolve each branch fully before moving to the next. Do not move on while anything is vague or hand-wavy.

Mark each resolved branch explicitly: "Good — that's settled. Moving on."
